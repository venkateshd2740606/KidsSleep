...
1. Open `D:\Work\Games\KidsSleep` in Android Studio.
...
The project is scaffolded from PuzzleVerse. Replace `engine/ScrewPuzzleEngine.kt` with `KidsSleepEngine.kt` (tube pour logic) and update the game board UI component.
