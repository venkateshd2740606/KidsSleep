#!/usr/bin/env python3
"""Generate KidsSleep Android project files."""
import os
from pathlib import Path

ROOT = Path(r"d:\Work\Games\KidsSleep")
APP = ROOT / "app"
MAIN = APP / "src" / "main"
JAVA = MAIN / "java" / "com" / "kidssleep"
TEST = APP / "src" / "test" / "java" / "com" / "kidssleep"
ANDROID_TEST = APP / "src" / "androidTest" / "java" / "com" / "kidssleep"
...
android {
    namespace = "com.kidssleep"
    compileSdk = 35

    defaultConfig {
        applicationId = "com.kidssleep.game"
        minSdk = 26
        targetSdk = 35
        versionCode = 1
        versionName = "1.0.0"
...
-keep class com.kidssleep.data.** { *; }
-keep class com.kidssleep.domain.model.** { *; }
...
files[APP / "google-services.json"] = '''{
  "project_info": {
    ...
    "project_id": "kidssleep-game",
    "storage_bucket": "kidssleep-game.firebasestorage.app"
  },
  "client": [{
    "client_info": {
      "mobilesdk_app_id": "1:000000000001:android:0000000000000000000001",
      "android_client_info": { "package_name": "com.kidssleep.game" }
    },
    "oauth_client": [],
...
if __name__ == "__main__":
    print("Generating KidsSleep project files...")
