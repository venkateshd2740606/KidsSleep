package com.kidssleep.presentation.ui.screens.settings
...
import com.kidssleep.presentation.ui.util.languageDisplayName
import com.kidssleep.presentation.ui.util.localizedName
import com.kidssleep.presentation.viewmodel.SettingsViewModel
import com.kidssleep.util.SupportedLanguages
...
fun SettingsScreen(
    ...
    var showStoryLanguageDialog by remember { mutableStateOf(false) }
    ...
    Scaffold(
        ...
        Column(
            ...
            TextButton(onClick = { showStoryLanguageDialog = true }, modifier = Modifier.fillMaxWidth()) {
                Column {
    ...
    if (showStoryLanguageDialog) {
        AlertDialog(
            onDismissRequest = { showStoryLanguageDialog = false },
            ...
            confirmButton = {
                TextButton(onClick = { showStoryLanguageDialog = false }) {
                    Text(stringResource(R.string.close))
                }
            }
        )
